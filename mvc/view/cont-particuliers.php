<?php
$particuliers = $model->getInfoPage('particuliers');
 ?>
 <section>
   <div class="container ul_unset">
     <div class="row">
         <h1 class="col-12 col-lg-6"><?php echo $particuliers['titre']?></h1>
     </div>

     <div class="row">
       <div class="col-12 col-lg-5 offset-lg-1 custom-text scrollpoint sp-effect1">
         <div><?php echo $particuliers['texte_left']?></div>
       </div>
       <div class="col-12 col-lg-5 offset-lg-1 custom-text scrollpoint sp-effect1">
         <div><?php echo $particuliers['texte_right']?></div>
       </div>
     </div>
  </div>
</section>
